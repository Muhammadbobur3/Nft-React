        ...
        <div className="flex flex-wrap justify-center gap-10">
          <div className="flex">
            <div className="flex flex-col justify-center mt-14">
              <img width={320} src={dog} alt="image" />
              <div className="flex justify-center align-center pt-3 gap-3">
                <img className="w-25 h-25" src={cat} alt="image" />
                <img className="w-25 h-25" src={bear} alt="image" />
                <button className="px-2 text-white text-3xl bg-purple-500 rounded-3xl p-0">1025+</button>
              </div>
          ...
          <div className="flex">
            <div className="flex flex-col justify-center mt-14">
              <img width={320} src={mushroom} alt="image" />
              <div className="flex justify-center align-center pt-3 gap-3">
          ...
          <div className="flex">
            <div className="flex flex-col justify-center mt-14">
              <img width={320} src={disco} alt="image" />
              <div className="flex justify-center align-center pt-3 gap-3">
